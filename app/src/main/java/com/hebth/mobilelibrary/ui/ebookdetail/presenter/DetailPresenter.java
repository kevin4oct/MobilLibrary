package com.hebth.mobilelibrary.ui.ebookdetail.presenter;
...
import com.hebth.mobilelibrary.ui.ebookdetail.model.DetailModel;
import com.hebth.mobilelibrary.ui.ebookdetail.model.IDetailModel;
import com.hebth.mobilelibrary.ui.ebookdetail.model.OnDetailListener;
import com.hebth.mobilelibrary.ui.ebookdetail.model.OnDownLoadListener;
import com.hebth.mobilelibrary.ui.ebookdetail.view.IDetailView;
...
public class DetailPresenter {
    ...
    public void loadData() {
        ...
        mModel.loadData(mView.getBookId(), new OnDetailListener() {
            ...
            public void success(BookDetailBean bean) {
                ...
                //作者
                mView.setBookAuthor(data1Bean.getBookAuthor() + "著");
                //出版社
                mView.setPress(data1Bean.getPress());
                //出版时间
                ...
                //获取电子书封面的url
                mView.setCover(AppConstant.RESOURCESTR + data1Bean.getBookPictures().get(0).getFilePath());
                //
                mView.stopLoading();
            }
    ...
    public void downloadCover() {
        ...
        mModel.downLoadCover(mView.getCover(), fileName,
                new OnDownLoadListener() {
                    @Override
                    public void success(long taskId, String filePath) {
