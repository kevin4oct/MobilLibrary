package com.hebth.mobilelibrary.ui.borrowList;
...
import com.hebth.mobilelibrary.ui.borrowList.net.BorrowListRequestParams;
...
public class BorrowListActivity extends BaseActivity {
    ...
    private BorrowListRecyclerAdapter adapter;
    private LinearLayoutManager layoutManager;

    public static Intent getBorrowListIntent(Context context) {
    ...
    public void initView() {
        ...
        adapter = new BorrowListRecyclerAdapter();
    ...
    private void getDateFormNet(final int type) {
        ...
        BorrowListRequestParams recommendRequestParams = new BorrowListRequestParams();
        ...
        x.http().post(recommendRequestParams, new Callback.CommonCallback<List<BookBean>>() {
            ...
            public void onSuccess(List<BookBean> result) {
                if (result == null || result.size() == 0) {
                    ToastUtils.showText(BorrowListActivity.this, "已无更多结果..");
                } else {
                    switch (type) {
                        case LOAD://上拉加载
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                ToastUtils.showText(BorrowListActivity.this, "未查询到结果..");
            }
     ...
     * recyclerview的适配器
     */
    private class BorrowListRecyclerAdapter extends RecyclerView.Adapter<BorrowlistRecyclerViewholder> {

        private LayoutInflater inflater = LayoutInflater.from(BorrowListActivity.this);

        @Override
        public BorrowlistRecyclerViewholder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = inflater.inflate(R.layout.item_recycler_opaclist, parent, false);
            BorrowlistRecyclerViewholder viewholder = new BorrowlistRecyclerViewholder(view);
            return viewholder;
        }

        @Override
        public void onBindViewHolder(BorrowlistRecyclerViewholder holder, int position) {
     ...
     */
    private class BorrowlistRecyclerViewholder extends RecyclerView.ViewHolder {
        ...
        public BorrowlistRecyclerViewholder(View itemView) {
            super(itemView);
